...
namespace SpecialEducationGames
{
    public static class RectTransformModifier
    {
        ...
        public static void SetAnchors(this RectTransform rectTransform, AnchorPresets anchor)
        {
        ...
        public static void GetVectorsFromAnchor(AnchorPresets anchorPresets, out Vector2 anchorMax, out Vector2 anchorMin)
        {
            ...
            switch (anchorPresets)
            {
                ...
                case AnchorPresets.LowerRight:
                    ...
                    break;
                case AnchorPresets.FullScreen:
                    anchorMax = new Vector2(1, 1);
                    anchorMin = new Vector2(0, 0);
                    break;
                case AnchorPresets.FullHorizontalLower:
                    anchorMax = new Vector2(1, 0);
                    anchorMin = new Vector2(0, 0);
                    break;
                case AnchorPresets.FullHorizontalCenter:
                    anchorMax = new Vector2(1, 0.5f);
                    anchorMin = new Vector2(0, 0.5f);
                    break;
                case AnchorPresets.FullHorizontalUpper:
                    anchorMax = new Vector2(1, 1);
                    anchorMin = new Vector2(0, 1);
                    break;
                case AnchorPresets.FullVerticalLeft:
                    anchorMax = new Vector2(0, 1);
                    anchorMin = new Vector2(0, 0);
                    break;
                case AnchorPresets.FullVerticalCenter:
                    anchorMax = new Vector2(0.5f, 1);
                    anchorMin = new Vector2(0.5f, 0);
                    break;
                case AnchorPresets.FullVerticalRight:
                    anchorMax = new Vector2(1, 1);
                    anchorMin = new Vector2(1, 0);
                    break;
                default:
